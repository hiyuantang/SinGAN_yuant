...
python train.py --input_image balloons_downsampled.png --number_of_noises 3 # model 3
...
python train.py --input_image pyramids_downsampled.jpg --number_of_noises 3 # model 3
